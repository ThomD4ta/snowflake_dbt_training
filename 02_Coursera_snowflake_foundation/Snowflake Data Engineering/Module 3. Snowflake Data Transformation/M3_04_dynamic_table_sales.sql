...
-- Insert dummy data for a sale occurring at a location in Hamburg / Insert as much dummy data as required for your test
-- Dummy data will be uploaded any TARGET_LAG is reached
...
DROP DYNAMIC TABLE tasty_bytes.raw_pos.daily_sales_hamburg;