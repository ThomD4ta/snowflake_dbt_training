...
-- TABLE INVENTORY
-- ===========================
-- Source tables (Snowflake Free Data)
--   SNOWFLAKE_PUBLIC_DATA_FREE.PUBLIC_DATA_FREE.OECD_TIMESERIES
--   SNOWFLAKE_PUBLIC_DATA_FREE.PUBLIC_DATA_FREE.OECD_ATTRIBUTES
--   SNOWFLAKE_PUBLIC_DATA_FREE.PUBLIC_DATA_FREE.BUREAU_OF_LABOR_STATISTICS_PRICE_TIMESERIES
--   SNOWFLAKE_PUBLIC_DATA_FREE.PUBLIC_DATA_FREE.BUREAU_OF_LABOR_STATISTICS_PRICE_ATTRIBUTES
--
-- Analytics tables (created in wages_cpi.data)
--   wages_cpi.data.annual_wages_cpi_usa
--   wages_cpi.data.monthly_cpi_usa
